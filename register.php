            ...
            <center><img src="assets/uploadImage/Logo/CyTrack.png" style="width: 100px; margin-top: -20%;"></center><br><br><br><br>
              ...
              <div class="form-group col-md-12">
                ...
                <div class="form-group col-md-12">
                  ...
                  <input type="date" name="nacimientodouser" id="nacimientodouser" min='1900-01-01' max='2013-12-31' class="form-control" placeholder="" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" title="Apellido no permitido" required="">
