                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="input-states">
                            <form class="form-horizontal" method="POST" id="submitUserForm" href="notas.php?rol=<?php echo $rol;?>&id=<?php" action="php_action/agregarnota.php?rol=<?php echo $rol;?>&id=<?php  echo $_SESSION['userId'];?>" enctype="multipart/form-data">
